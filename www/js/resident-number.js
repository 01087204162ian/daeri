...
/**
 * 주민번호 유효성 검사
 * @param {string} front 앞 6자리 (YYMMDD)
 * @param {string} back 뒤 7자리
 * @returns {object} { isValid: boolean, error?: string, age?: number, ageGroup?: string }
 */
function validateResidentNumber(front, back) {
    // 기본 검증
    if (!front || !back) {
